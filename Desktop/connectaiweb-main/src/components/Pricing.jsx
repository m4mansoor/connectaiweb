...
export default function Pricing({ onButtonClick }) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <button 
              ...
              className="w-full bg-indigo-600 text-white px-6 py-3 rounded-full hover:bg-indigo-700 transition-colors"
            >
              Get Started Monthly
            </button>
          </motion.div>
          ...
          >
            ...
            <button 
              onClick={onButtonClick}
              className="w-full bg-white text-indigo-600 px-6 py-3 rounded-full hover:bg-indigo-50 transition-colors font-semibold"
            >
              Get Lifetime Access
            </button>
          </motion.div>
        ...
        >
          <p className="text-gray-600 text-lg">
            🔥 Don't miss out on these special Launch Prices! Regular pricing
            will be $9.97/month or $147 for lifetime access.
          </p>
        </motion.div>
      </div>
    </div>
